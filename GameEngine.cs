namespace DTTD.Engine
{
    ...
    public class GameEngine : IEngine
    {
        ...
        {
            //Selectors
            var Mage = (this.players.Where(p => p.Name == nameOfPlayer).Select(p => p.Type)) as Mage;
            var Warrior =(this.players.Where(p => p.Name == nameOfPlayer).Select(p => p.Type)) as Warrior;
            var Rogue = (this.players.Where(p => p.Name == nameOfPlayer).Select(p => p.Type)) as Rogue;
